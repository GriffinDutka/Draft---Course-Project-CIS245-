...
def zipcode():
    ...
    if question == 'yes':
        main()
    if question == 'no':
        print("Thank you for choosing my weather service! See you next time!")
        exit()
...
def city():
    ...
    if question == 'yes':
        main()
    if question == 'no':
        print("Thank you choosing our weather service. Have a great day!")
        exit() 
    ...
    while True:
        ...
        if answer == 'city':
            try:
                ...
                print("Please enter a valid US city! Try again!")
                city()
        else:
